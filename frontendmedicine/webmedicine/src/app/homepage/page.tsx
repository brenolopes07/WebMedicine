    ...
    <>
      ...
      <div className="flex flex-col items-center text-center px-4 border-b">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 mt-6 w-full max-w-xl">
          <Input value={busca} onChange={(e) => setBusca(e.target.value)}
            ...
            className="w-full"
          />
          <Button className="w-110 md:w-auto bg-blue-500 hover:bg-blue-600 text-white cursor-pointer" onClick={handleBuscar}>
            Buscar Médicos
          </Button>
        </div>
      ...
      <div className="flex flex-col md:flex-row mt-12 justify-center items-center gap-12 px-4 mb-12">
        <div className="flex items-center flex-col text-center gap-4 bg-white p-6 rounded-lg shadow-md w-full max-w-xs">
          ...
          <h2 className="text-gray-400">Busque medicos por nome, especialidade e encontre o profissional ideal para voce.</h2>
        </div>

        <div className="flex items-center flex-col text-center gap-4 bg-white p-6 rounded-lg shadow-md w-full max-w-xs">
          <Calendar className="w-12 h-12 text-blue-500" />
          <h1 className="font-semibold text-lg">Agende Consultas</h1>
          <h2 className="text-gray-400">Veja a disponibilidade em tempo real e marque sua consulta em poucos cliques, sem complicacoes</h2>
        </div>

        <div className="flex items-center flex-col text-center gap-4 bg-white p-6 rounded-lg shadow-md w-full max-w-xs">
          <User className="w-12 h-12 text-blue-500" />
          <h1 className="font-semibold text-lg">Gerencie seu Cuidado</h1>
          <h2 className="text-gray-400">Acompanhe seu historico de consultas e recebe lembretes sobre seus proximos agendamentos</h2>
        </div>
      </div>
    </>
  );
